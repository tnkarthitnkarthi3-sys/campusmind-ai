...
const features = [
  "College-wide announcements",   "Department announcements",   "Course targeting",   "Semester targeting",   "Publish / unpublish",   "Expiry management",
];
...
export default function Page() {
  ...
  const Icon = iconMap["Megaphone"] || ShieldCheck;
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-500">
              Publish official college and academic announcements to targeted audiences.
            </p>
          </div>
